## Домашнее задание к занятию "`Система мониторинга Zabbix Часть 2`" - `Айткожоев Бактыбек`
...
![Скриншот авторизации в админке](img/Dashbord.jpg)
...
![1. Скриншот страницы шаблона с названием «Задание 1»](img/Task1.png)
 ---
...
#### Требования к результату
- [ ] Cкриншот страницы хостов, с привязками к шаблонам «Задание 2-3». Хосты имеют зелёный статус подключения
![Cкриншот страницы хостов, с привязками к шаблонам «Задание 2-3». Хосты имеют зелёный статус подключения](img/Task2-3.png)
 ---
...
#### Требования к результату
- [ ] Cкриншот дашборда «Задание 4»
![Cкриншот дашборда «Задание 4»](img/MyDashboard.png)
 ---
